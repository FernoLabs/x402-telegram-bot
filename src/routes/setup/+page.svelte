...
<section class="page" aria-labelledby="setup-title">
	...
	<ol class="checklist" aria-label="Group setup steps">
		<li>
			...
			<p>
				Search for <strong>{botHandle}</strong> in Telegram, add it as an admin, and enable the ability
				to post, pin, and delete messages. Keep other permissions off until you are ready to go live.
			</p>
			{#if botId}
		...
		<li>
			...
			<p>
				Use the <a href="/send">Send a Message</a> page to fund a small test. Confirm the copy, the payment
				receipt, and that the post reaches your group.
			</p>
		</li>
	</ol>
...
<style>
	...
	code {
		font-family:
			'Source Code Pro', Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace;
		background: #f1f5f9;
